...
const TRANSLATIONS = {
  ko: {
    ...
    map_mode_job:'알바', map_mode_moim:'모임', swipe_nearby_count_txt:'주변 알바 {n}개 — 스와이프로 보기',
  ...
  en: {
    ...
    map_mode_job:'Jobs', map_mode_moim:'Groups', swipe_nearby_count_txt:'{n} nearby jobs — Swipe to view',
  ...
  zh: {
    ...
    map_mode_job:'兼职', map_mode_moim:'聚会', swipe_nearby_count_txt:'附近兼职{n}个 — 滑动查看',
  ...
  ja: {
    ...
    map_mode_job:'バイト', map_mode_moim:'集まり', swipe_nearby_count_txt:'近くのバイト{n}件 — スワイプで見る',
  ...
  vi: {
    ...
    map_mode_job:'Việc làm', map_mode_moim:'Nhóm', swipe_nearby_count_txt:'{n} việc gần đây — Vuốt để xem',
  ...
  mn: {
    ...
    map_mode_job:'Ажил', map_mode_moim:'Хамт олон', swipe_nearby_count_txt:'Ойролцоо {n} ажил — Свайп хийж үзэх',
  ...
  ru: {
    ...
    map_mode_job:'Работа', map_mode_moim:'Группы', swipe_nearby_count_txt:'Рядом {n} вакансий — смахните для просмотра',
  ...
  np: {
    ...
    map_mode_job:'काम', map_mode_moim:'समूह', swipe_nearby_count_txt:'नजिक {n} काम — स्वाइप गरी हेर्नुहोस्',
