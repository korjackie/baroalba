...
const OB_TRANS = {
  ko: [
    { title: '내 주변 알바·모임을\n지도에서 한눈에', desc: '걸어갈 수 있는 거리의 알바와 모임을\n지도에서 바로 발견하세요.', chips: ['📍 위치 기반', '🗺 직관적 지도', '🔍 맞춤 필터'] },
    { title: '8개 언어로\n전 세계인과 바로 소통', desc: '언어 장벽 없는 글로벌 플랫폼!\n외국인 알바생도, 외국인 친구도 쉽게 찾아요.', chips: ['🌍 8개국어 완벽 지원', '💬 실시간 자동 번역', '🤝 외국인 환영'] },
    { title: '알바를 넘어\n취미와 네트워킹까지', desc: '퇴근 후 바로모임에서 취미를 공유하고\n바로만남으로 새로운 인연을 만들어보세요.', chips: ['🎉 소셜 모임', '🍷 동네 네트워킹', '💖 두근두근 만남'] },
    { title: '사장님도 알바생도\n바로 구하고 바로 일해요', desc: '3분 만에 공고를 올리고 알림을 받으세요.\n급할 땐 바로페이 선정산까지!', chips: ['🚀 3분 공고 등록', '💸 안전한 에스크로', '🔔 실시간 매칭'] },
    { title: '당신의 새로운 일상,\n지금 바로 시작하세요', desc: '단기 알바부터 특별한 모임까지\n모든 준비가 끝났습니다.', chips: ['✨ 프로필 설정', '👑 신원 인증', '🎉 혜택 받기'] }
  ],
  en: [
