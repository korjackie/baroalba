...
> 최종 갱신: **2026-08-02** (sw.js **v612** / Phase 80~88 — CSS 문법 감사 · 스키마 드리프트 2차 · 홈 게스트 언어선택기 · 브랜드명 로마자 · **app_admins 보안 적용** · 관리자 지정 UI · 중복 ID · **`api/*.js` 전수 대조** · **무료재화 정리(쿠폰↔이용권 연결·신규가입 웰컴·추천 어뷰징)**. 앞서 Phase 75~79)
...
- 라이브 `baroalba-v612`, 작업트리 깨끗, `origin/main` 과 동기화됨
