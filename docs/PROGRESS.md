...
> 최종 갱신: **2026-07-31** (sw.js **v598** / Phase 75 — 프리미엄 디자인 시스템 1차: 글자 굵기 7종→4종)
...
②2차 색 — `#aaa`·`#bbb` 474회를 `--ink-400` 으로 올리는 게 핵심(대비↑, 시니어 가독성↑).
**`#f0f0f0` 이 border 106회·background 49회로 문맥이 갈리므로 단순 문자열 치환 금지**
③3차 모서리·그림자 ④4차 간격은 별도 스펙으로 분리
