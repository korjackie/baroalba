...
> 최종 갱신: **2026-08-01** (sw.js **v605** / Phase 80~81 — CSS 문법 감사 4건 + 스키마 드리프트 2차로 매니저 페이지 전면 복구. 앞서 Phase 75~79)
...
- 라이브 `baroalba-v605`, 작업트리 깨끗, `origin/main` 과 동기화됨 (마지막 커밋 `dfe4122`)
